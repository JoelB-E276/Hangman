...
let re = splitWord.includes(playerChoice.length); // renvoi true/false de manière aléatoire. ?

console.log(re);  

    if (splitWord.includes(playerChoice.length)) ;
...
function counter(){     // Comptage du score et fin du jeu en cours
    ...
    if (score === 0){
        return alert(" PERDU ! Tu as été pendu!! ") 
    }
}
